...
int main(){
	...
	{"Pneumatic rubber tire","Automobile wheel rim","Rubber boot","None of these"},
	...
	{"G. Ferdinand Von Zeppelin","Sir Frank Whittle","Roger Bacon","Leo H Baekeland"},
					    };
	string correctOptions[10] = {
		"Biro Brothers","Pneumatic rubber tire","Marie Curie","Thermometer",
		"Neil Armstrong","National people’s Congress","Africa",
		"Washington DC","Jordan","Roger Bacon"
								};
